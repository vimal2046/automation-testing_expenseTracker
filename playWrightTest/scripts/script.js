document.addEventListener("DOMContentLoaded", function () {
        ...
        if (filteredExpenses.length === 0) {
            ...
            filteredExpenses.forEach((expense, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <span class="badge ${getCategoryBadgeClass(expense.category)}">${expense.category}</span>
                    </td>
        ...
        row.innerHTML = `
            ...
            <td>
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" class="form-control" value="${expense.amount}" id="edit-amount" min="0" step="0.01">
                </div>
            </td>
            <td>
            ...
            <td><input type="text" class="form-control form-control-sm" value="${expense.description}" id="edit-description"></td>
            <td><input type="date" class="form-control form-control-sm" value="${expense.date}" id="edit-date"></td>
            <td class="text-center">
                <button class="btn btn-success btn-sm update-expense me-1">
    ...
    function updateExpense(event) {
        ...
        const updatedDescription = document.getElementById("edit-description").value || "No description";
